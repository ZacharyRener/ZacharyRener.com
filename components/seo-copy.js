...
export default function SEOCopy(props) {
  return (
    <section className={styles.SEOCopy + " " + "container"}>
      <h1 className={styles.seoH1}>Full-Stack Web Developer</h1>
      <div className={styles.contentWrapper}>
        <div className={styles.left}>
          <p className={styles.seoP}>
            Located just outside of the Denton Square, Zach is a local web
            developer that can help you with your next project. With the
            experience
          </p>
        </div>
